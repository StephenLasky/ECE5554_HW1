...
% image1 = im2single(imread('kenny.png'));
% image2 = im2single(imread('stan.png'));
image1 = im2single(rgb2gray(imread('kenny.png')));
image2 = im2single(rgb2gray(imread('stan.png')));

% image1 = im2single(imread('data/bird.bmp'));
% image2 = im2single(imread('data/plane.bmp'));
% image1 = im2single(rgb2gray(imread('data/bird.bmp')));
% image2 = im2single(rgb2gray(imread('data/plane.bmp')));
...
cutoff_frequency = 4.5; %This is the standard deviation, in pixels, of the 
...
figure(10); imshow(vis_hybrid_image(hybrid_image));
